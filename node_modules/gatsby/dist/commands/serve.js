...
/*#__PURE__*/
function () {
  var _ref2 = (0, _asyncToGenerator2.default)(function* (program) {
    ...
    const _ref3 = config || {},
          configPathPrefix = _ref3.pathPrefix;
    ...
    const matchPaths = yield readMatchPaths(program);
