...
const _require2 = require(`../schema/types/type-builders`),
      buildObjectType = _require2.buildObjectType,
      buildUnionType = _require2.buildUnionType,
      buildInterfaceType = _require2.buildInterfaceType,
      buildInputObjectType = _require2.buildInputObjectType;
...
const _require4 = require(`./stack-trace-utils`),
      getNonGatsbyCodeFrame = _require4.getNonGatsbyCodeFrame;

const _require5 = require(`gatsby-telemetry`),
      trackBuildError = _require5.trackBuildError,
      decorateEvent = _require5.decorateEvent; // Bind action creators per plugin so we can auto-add
...
const runAPI = (plugin, api, args) => {
  ...
  if (gatsbyNode[api]) {
    ...
    const _require6 = require(`../redux`),
          ...
          emitter = _require6.emitter;

    const _require7 = require(`../db/nodes`),
          loadNodeContent = _require7.loadNodeContent,
          getNodes = _require7.getNodes,
          getNode = _require7.getNode,
          getNodesByType = _require7.getNodesByType,
          hasNodeChanged = _require7.hasNodeChanged,
          getNodeAndSavePathDependency = _require7.getNodeAndSavePathDependency;

    const _require8 = require(`../redux/actions`),
          publicActions = _require8.publicActions,
          restrictedActionsAvailableInAPI = _require8.restrictedActionsAvailableInAPI;
    ...
    return new Promise(resolve => {
      ...
      Promise.mapSeries(implementingPlugins, plugin => {
        ...
        if (apisRunningById.size === 0) {
          const _require10 = require(`../redux`),
                emitter = _require10.emitter;
