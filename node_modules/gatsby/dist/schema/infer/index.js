...
const _require = require(`graphql-compose`),
      ObjectTypeComposer = _require.ObjectTypeComposer;

const _require2 = require(`./example-value`),
      getExampleValue = _require2.getExampleValue;

const _require3 = require(`../types/node-interface`),
      addNodeInterface = _require3.addNodeInterface,
      getNodeInterface = _require3.getNodeInterface;

const _require4 = require(`./add-inferred-fields`),
      addInferredFields = _require4.addInferredFields;
