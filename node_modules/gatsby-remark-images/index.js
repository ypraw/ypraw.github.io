...
module.exports = function (_ref, pluginOptions) {
  ...
  var generateImagesAndUpdateNode = function generateImagesAndUpdateNode(node, resolve, inLink, overWrites) {
    var parentNode, imagePath, imageNode, fluidResult, originalImg, fallbackSrc, srcSet, presentationWidth, srcSplit, fileName, fileNameNoExt, defaultAlt, alt, title, loading, imageTag, webpFluidResult, placeholderImageData, args, _require4, Potrace, argsKeys, tracedSVG, ratio, wrapperStyle, imageCaption, removeBgImage, imageStats, bgImage, rawHTML;
